...
class TestCredentials(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credentials.credentials_name,"Victor")
        self.assertEqual(self.new_credentials.usr_name,"Rocker")
        self.assertEqual(self.new_credentials.password,"123456789")
        self.assertEqual(self.new_credentials.email,"victor@g.com")
